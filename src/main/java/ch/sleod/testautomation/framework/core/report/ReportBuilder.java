package ch.sleod.testautomation.framework.core.report;
...
import ch.sleod.testautomation.framework.core.json.container.JSONStepResult;
import ch.sleod.testautomation.framework.core.json.container.JSONTestResult;
    ...
    private static void generateDefaultAllureResults(List<TestCaseObject> testCaseObjects) throws IOException {
        ...
        for (TestCaseObject testCaseObject : testCaseObjects) {
            ...
            testCaseObject.getSteps().forEach(testCaseStep -> {
                ...
                JSONStepResult jsonStepResult = new JSONStepResult(testCaseStep.getTestStepResult());
