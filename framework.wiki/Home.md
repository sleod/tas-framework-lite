...
* [How Selenide creates WebDriver](How-Selenide-creates-WebDriver.md)
  * [Safari browser](Safari.md)
* [Build script](Build-script.md)
* [Soft assertions](SoftAssertions.md)
* [Selenide Roadmap](Selenide-Roadmap.md)
#### [Selenide Blog an Release Notes](https://selenide.org/blog.html)
#### [Selenide API on GitBook](https://selenide.gitbooks.io/user-guide/content/en/selenide-api/selenide.html)